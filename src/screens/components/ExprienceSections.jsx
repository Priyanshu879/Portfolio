...
function VerticleLine() {
  return (
    <div className="-z-10 h-3/4 absolute left-1/2 hidden md:block">
...
export default function ExprienceSection({ id }) {
  return (
    <div className="h-full w-full mt-64" id={id}>
      <div className="font-oswald text-center text-5xl mb-5">Experience</div>
