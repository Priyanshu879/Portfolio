...
export default function Header() {
  return (
    <div className='w-full h-auto shadow-sm hidden md:flex items-center bg-black text-center sticky top-0 z-10 shadow-gray-700 text-3xl font-oswald py-2'>
       ...
       <div className=' flex justify-evenly items-center flex-[2] text-xl'>
            ...
            <a href="./src/assets/PriyanshuResume.pdf" download><div className='flex justify-center hover:cursor-crosshair'>
